...
static void lcm_panel_init(struct lcm *ctx)
{
	...
	lcm_dcs_write_seq_static(ctx, 0xF0, 0xC2, 0x0D, 0x00);
	...
	lcm_dcs_write_seq_static(ctx, 0xF0, 0xD0, 0x01, 0x32);
	lcm_dcs_write_seq_static(ctx, 0xD9, 0x01, 0x02, 0x5C, 0x00, 0x00, 0x0C, 0x00, 0x00, 0x00, 0x00, \
